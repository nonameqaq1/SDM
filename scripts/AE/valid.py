...
if __name__ == "__main__":
    ...
    for i_iter, batch in enumerate(valid_dataloader):
        ...
        tmp_fps = args.batch_size * real_vids.size(2) / (end - start)
        ...
        print('Test:[{0}/{1}]\t''Time {batch_time.val:.3f}({batch_time.avg:.3f})'.format(i_iter, NUM_ITER,
