...
if __name__ == "__main__":
    ...
    parser.add_argument("--config",default="/home/cityscapes128.yaml",help="path to config")
    parser.add_argument("--log_dir",default='/homelogs_training/AE/cityscapes', help="path to log into")
