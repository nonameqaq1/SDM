...
if __name__ == '__main__':
    ...
    parser.add_argument("--log_dir", default='/home/logs_training/DM/kth', help="path to log into")
    parser.add_argument("--config", default="/home/config/DM/kth.yaml", help="path to config")
    ...
    parser.add_argument("--flowae_checkpoint",  # use the flowae_checkpoint pretrained model provided by Snap
                        default="/home/logs_training/AE/kth/kth_test/snapshots/RegionMM.pth",
